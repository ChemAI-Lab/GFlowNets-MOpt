...
python scripts/metrics_histo_pareto.py H2 --wfn FCI --y-axis groups

# 2) Generate SI vs GFlowNet Pareto plot
python scripts/ics_histo_pareto.py H2 --wfn FCI --y-axis groups

# 3) Add ICS overlays (SI->ICS and GFlowNet->ICS)
python scripts/ics_histo_pareto.py H2 --wfn FCI --y-axis groups --ics
```
